...
import com.betanooblabs.rockpaperscissor.databinding.ActivityPlayWithOtherBinding
...
class PlayWithOther : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.playWithOther)) { v, insets ->
