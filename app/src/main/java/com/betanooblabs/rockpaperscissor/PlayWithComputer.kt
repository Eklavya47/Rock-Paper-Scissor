...
import com.betanooblabs.rockpaperscissor.databinding.ActivityPlayWithComputerBinding
...
class PlayWithComputer : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.playWithComputer)) { v, insets ->
